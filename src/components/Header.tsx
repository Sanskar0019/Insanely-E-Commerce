    ...
    <header className="sticky top-0 left-0 w-full  z-50 bg-gradient-to-l from-primary-400 via-primary-200 to-primary-300 text-gray-800 py-3 px-6 shadow-md sora-header rounded-b-3xl">
      <div className="flex items-center justify-between">
        ...
        <nav className="flex gap-6 text-lg font-medium">
          <a href="/shop?category=Men&sort=default" className="hover:text-primary-600 transition-colors duration-300">Men</a>
          <a href="/shop?category=Women&sort=default" className="hover:text-primary-600 transition-colors duration-300">Women</a>
          <a href="/shop?category=Kids&sort=default" className="hover:text-primary-600 transition-colors duration-300">Kids</a>
          <a href="/shop?category=Unisex&sort=default" className="hover:text-primary-600 transition-colors duration-300">Unisex</a>
        </nav>
      </div>
